...
if(Boolean(document.getElementById('partField'))){
...
if(Boolean(document.getElementById('faktp4x'))){
 var resState = 0
 var upscaleBlogImg = document.getElementById('upscaleBlogImg');

 upscaleBlogImg.addEventListener('click',function(){
  if(resState == 0){
   document.getElementById('faktp4x').innerHTML = '<img id="faktp4xImg" src="ailmpintro4x.png" alt="Intro image 4x" width="800" height="400"/>'
   document.getElementById('faktp4x2').innerHTML = '1x'
   resState = 1
  }
  else if(resState == 1){
   document.getElementById('faktp4x').innerHTML = '<img id="faktp1xImg" src="ailmpintro.png" alt="Intro image" width="800" height="400"/>'
   document.getElementById('faktp4x2').innerHTML = '4x'
   resState = 0
  }
 })
}